...
public class CarriageBogeyCreateTrainParts {
	public static final StreamCodec<RegistryFriendlyByteBuf, CarriageBogeyCreateTrainParts> STREAM_CODEC = StreamCodec.composite(
			...
			CarriageBogeyCreateTrainParts::new
	);
	...
	public CarriageBogeyCreateTrainParts(AbstractBogeyBlock<?> type, boolean upsideDown, CompoundTag bogeyData) {
		this(type, upsideDown, bogeyData, new TravellingPoint(), new TravellingPoint());
	}

	public CarriageBogeyCreateTrainParts(AbstractBogeyBlock<?> type, boolean upsideDown, CompoundTag bogeyData, TravellingPoint point, TravellingPoint point2) {
		this.type = type;
	...
	public static CarriageBogeyCreateTrainParts read(CompoundTag tag, TrackGraph graph, DimensionPalette dimensions) {
		...
		return new CarriageBogeyCreateTrainParts(type, upsideDown, data, points.getFirst(), points.getSecond());
	}
